...
![Given p1, p2 ~ Uni\(0, 5\), the space created is a square and the surface is a fat plane at the top of it](../../.gitbook/assets/image%20%2825%29.png)
...
![Prior probability recreated as the surface given p1~Exp\(3\), p2~Exp\(10\)](../../.gitbook/assets/image%20%2867%29.png)
...
![Landscape for both distributions given an observation](../../.gitbook/assets/image%20%2850%29.png)
